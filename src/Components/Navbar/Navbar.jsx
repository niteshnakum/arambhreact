...
//           <h1>Arambh<span>Technologies</span></h1>
//         </a> */}
//         <Link to="/" className="logo d-flex align-items-center"><h1>Arambh<span>Technologies</span></h1></Link>
//         <nav id="navbar" className={`navbar ${isMobileNavVisible ? 'navbar-mobile' : ''}`}>
...
//             <li><a href="#privacypolicy" onClick={() => handleLinkClick('#privacypolicy')} className={activeLink === '#privacypolicy' ? 'active' : ''}>PrivacyPolicy</a></li>
  ...
  return (
    <header id="header" className={`header d-flex align-items-center ${isScrolled ? 'sticked sticky-menu' : 'sticked'}`}>
      <div className="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" className={`navbar ${isMobileNavVisible ? 'navbar-mobile' : ''}`}>
          <ul>
            <li><Link to="/" onClick={() => handleLinkClick('#hero')} className={activeLink === '#hero' ? 'active' : ''}>Home</Link></li>
            <li><Link to="/services" onClick={() => handleLinkClick('#services')} className={activeLink === '#services' ? 'active' : ''}>Services</Link></li>
            <li><Link to="/about" onClick={() => handleLinkClick('#about')} className={activeLink === '#about' ? 'active' : ''}>About</Link></li>
            <li><Link to="/testimonials" onClick={() => handleLinkClick('#testimonials')} className={activeLink === '#testimonials' ? 'active' : ''}>Testimonials</Link></li>
            <li><Link to="/projects" onClick={() => handleLinkClick('#projects')} className={activeLink === '#projects' ? 'active' : ''}>Projects</Link></li>
            <li><Link to="/contact" onClick={() => handleLinkClick('#contact')} className={activeLink === '#contact' ? 'active' : ''}>Contact</Link></li>
            <li><Link to="/privacypolicy" onClick={() => handleLinkClick('#privacypolicy')} className={activeLink === '#privacypolicy' ? 'active' : ''}>Privacy Policy</Link></li>
          </ul>
        </nav>
        <i className={`mobile-nav-toggle bi ${isMobileNavVisible ? 'bi-x' : 'bi-list'}`} onClick={toggleMobileNav}></i>
      </div>
